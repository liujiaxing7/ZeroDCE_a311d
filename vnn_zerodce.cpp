...
vsi_nn_graph_t * vnn_CreateZeroDce
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Add_/Add_15/out0_0:out0 */
    attr.size[0] = 256;
    attr.size[1] = 256;
    attr.size[2] = 3;
    attr.size[3] = 1;
...
error:
    ...
    vnn_ReleaseZeroDce( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateZeroDce() */

void vnn_ReleaseZeroDce
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
